...
// Workaround สำหรับ Recharts type definitions (เหมือนเดิม)
...
export const PerformanceDashboard: React.FC<PerformanceDashboardProps> = ({ 
    ...
    // [✅ เพิ่ม] จัดการกรณีไม่มีข้อมูล
    if (tasksByOwner.length === 0 && tasksByStatus.every(s => s.Tasks === 0) && operationScore === "N/A") {
        return (
        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div className="lg:col-span-2 bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-200">
                    <h3 className="font-bold text-gray-700 mb-4">สัดส่วน Task ตามทีม/ผู้รับผิดชอบ</h3>
                    <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                            <PatchedPie
