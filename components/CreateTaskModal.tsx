...
export const CreateTaskModal: React.FC<CreateTaskModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-white/70 bg-opacity-50 z-40 flex justify-center items-center p-4">
      <div
        ...
        <form onSubmit={handleSubmit}>
          ...
          <footer className="flex justify-end p-6 bg-gray-50 border-t rounded-b-xl">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            >
              ยกเลิก
            </button>
            <button
